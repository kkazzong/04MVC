...
//	@Test
	public void testAddPurchase() throws Exception {
		...
		Product product = productDAO.findProduct(10003);
		
		Purchase purchase = new Purchase();
		purchase.setPurchaseProd(product);
		purchase.setBuyer(buyer);
		purchase.setPaymentOption("1");
		purchase.setReceiverName("토레스");
		purchase.setReceiverPhone("0422");
		purchase.setReceiverAddr("금강");
		purchase.setReceiverDate("2017-01-21");
